...
namespace RekTec.Application.Services
{
	public static class MenuService
	{
		...
		{
			try {
				RekTec.MyProfile.Services.SystemSettingService.AddCleanupAction ("menu_last_sync_time_clear", () => {
				...
				GlobalAppSetting.MenuStyle = mobileMenu.SystemMenuStyle;
