...
创建人   : Joe Song
创建时间 : 2015-04-16 
说明     : 用于Monotouch Dialog中的按钮的Element
****************/
#endregion
...
namespace RekTec.Corelib.Views
{
    ...
    public class ButtonElement : Element, IElementSizing
    {
        ...
        private void CreateButton(UITableView tv)
        {
            ...
            this._button = new GlassButton(new CGRect(UiStyleSetting.PaddingSizeMedium, 5, tv.Bounds.Width - UiStyleSetting.PaddingSizeMedium * 2, 50)) {
                Font = UIFont.BoldSystemFontOfSize((nfloat)16),
                NormalColor = UiStyleSetting.RektecBlueColor,
                HighlightedColor = UiStyleSetting.RekTecBlueColorHighlighted
            };
