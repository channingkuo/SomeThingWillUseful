    ...
    internal class SaslHandler : IDisposable
    {
            ...
            if (e.GetType() == typeof(protocol.stream.Features)) {
                ...
                if (!m_XmppClient.Authenticated) {
                    ...
                    if (f.SupportsBind) {
                        ...
                        m_XmppClient.IqGrabber.SendIq(bIq, new IqCB(BindResult), null, true);					
                    }
                }
        ...
        {	
            ...
            if (iq.Type == IqType.result) {				
                ...
                m_XmppClient.IqGrabber.SendIq(sIq, new IqCB(SessionResult), null, true);

            } else if (iq.Type == IqType.error) {
                throw new ApplicationException(iq.Error.ToString());
            }			
        }
