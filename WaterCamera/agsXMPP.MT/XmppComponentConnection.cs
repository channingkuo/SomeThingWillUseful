...
namespace agsXMPP
{
    ...
    public class XmppComponentConnection : XmppConnection
    {
        ...
        public XmppComponentConnection(string server, int port)
            : this()
        {		
            base.Server = server;
            base.Port = port;
        ...
        public XmppComponentConnection(string server, int port, string password)
            : this(server, port)
        {		
        ...
        {			
            // Send Handshake
            Send(new Handshake(this.m_Password, this.StreamId), string.Empty);
        }
        ...
        public override void Send(Element e, string id)
        {
            ...
            Send(toSend.Substring(35, toSend.Length - 35 - 4), id);
        }
