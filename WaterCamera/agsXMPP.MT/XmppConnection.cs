...
namespace agsXMPP
{
    ...
    public abstract class XmppConnection
    {
        ...
        /// </summary>
        public event ClientSocket.OnSocketDataHandler OnReadSocketData;
        
        /// <summary>
        /// Data was sent to the socket for sending
        /// </summary>
        public event ClientSocket.OnSocketDataHandler OnWriteSocketData;
        ...
        public virtual void SocketOnSendEnd(object id, bool isComplete)
        {
        ...
        /// </summary>
        /// <param name="e"></param>
        public virtual void Send(Element e, string id)
        {
            Send(e.ToString(), id);
        }

        public virtual async Task SendAsync(Element e, string id)
        {
            await SendAsync(e.ToString(), id);
        }
        ...
        {
            Send("</stream:stream>", string.Empty);
        }
