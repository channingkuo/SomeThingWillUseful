...
namespace RekTec.MyProfile.Views
{
	...
	public class MyProfileViewController : DialogViewController
	{
		...
		StyledStringElement _departmentElement, _settingElement, _personInfoElement;
			...
			: base (UITableViewStyle.Grouped, r, true)
		{
			...
			try {
				...
				_personInfoElement = new StyledStringElement ("个人资料") {
					Image = UIImage.FromFile ("person_info.png"),
					Accessory = UITableViewCellAccessory.DisclosureIndicator,
				...
				_root.Add (new [] { new Section () { _departmentElement, _personInfoElement, _settingElement } });
		...
		private void BindUiEvent ()
		{
			...
			_personInfoElement.Tapped += () => {
				var wvc = new WebViewController () { _menuUrl = "persondata/edit" };
